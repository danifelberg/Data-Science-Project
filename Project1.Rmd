...
summary(income_aov)
```
The p-value is less than 0.05, thus rejecting the null hypothesis. There are different average electricity consumption levels between different income levels.
