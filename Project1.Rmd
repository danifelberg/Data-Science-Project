...
Electricity consumption is related to people's life and survival, but people seldom pay attention to it. Do you know which appliance in your household uses the most electricity? According to the national household survey by EIA (U.S. Energy Information Administration), electricity used in heating is the highest in electricity consumption. Besides appliances, what are other important variables that affects electricity costs? The purpose of this study is to answer these questions: -What factors impact the electricity costs related to heat pump implementation? --Regression of electricity costs per sqft on households with heat pumps controlling for housing size, ex: number of rooms, square footage. -What factors impact the total electricity costs of a US household, and how strong is that impact? --Regressing total yearly electricity costs by US Census Divisions and climate type. --Regression of electricity costs controlling for income, urban area type ANOVA tests of best fit model.
