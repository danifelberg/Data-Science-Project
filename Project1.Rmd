...
Looking now at our second question, we create some general linear models looking specifically at the influence that income and urban density have on electricity cost.
...
Above we see several models that we have created, and at the very bottom, we have an ANOVA test comparing these different models. The last row has the regression with the lowest F-test, and lowest sum of squares error, meaning that, among the three, it is the preferred regression:
