...
# 1 Introduction
Electricity consumption is related to people's life and survival, but people seldom pay attention to it. Do you know which appliance in your household uses the most electricity? According to the national household survey by EIA (U.S. Energy Information Administration), electricity used in heating is the highest in electricity consumption. Besides appliances, what are other important  variables that affects electricity costs? The purpose of this study is to answer these questions: 
-What factors impact the electricity costs related to heat pump implementation?
--Regression of electricity costs per sqft on households with heat pumps controlling for housing size, ex: number of rooms, square footage. 
-What factors impact the total electricity costs of a US household, and how strong is that impact?
--Regressing total yearly electricity costs by US Census Divisions and climate type.
--Regression of electricity costs controlling for income, urban area type
ANOVA tests of best fit model.

 

# 2 Methods
This study examines the impact of household energy expenditure reported during the year 2015 from data from the Energy Information Administration. The study attempts to conduct exploratory data analysis (EDA) related to yearly household energy consumption, the expenditures of energy related to climate region, census income levels, and appliance types.
...
step(fullmodel)
xkabledply(step(fullmodel), title = paste("Full Model:", format(formula(fullmodel))))
plot(step(fullmodel))
